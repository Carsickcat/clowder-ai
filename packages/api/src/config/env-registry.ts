...
export const ENV_VARS: EnvDefinition[] = [
  ...
  {
    name: 'NOVA_INSPECTION_PROMETHEUS_SCOPE',
    defaultValue: '(未设置；配置 URL 时必须显式声明 development / acceptance / staging)',
    description: 'NOVA connected 巡检数据边界声明；production 会被拒绝',
    category: 'server',
    sensitive: false,
    hubVisible: false,
    runtimeEditable: false,
  ...
  {
    name: 'NOVA_INSPECTION_PROMETHEUS_AUTHORIZATION',
    defaultValue: '(未设置)',
    description: 'NOVA connected 巡检 Prometheus Authorization header（仅服务端）',
    category: 'server',
    sensitive: true,
    hubVisible: false,
    runtimeEditable: false,
