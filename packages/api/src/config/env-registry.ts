...
export const ENV_VARS: EnvDefinition[] = [
  ...
  {
    name: 'CAT_CAFE_TRUST_TAILSCALE_HEADERS',
    defaultValue: 'false',
    description:
      'Trust Tailscale Serve identity headers for remote session establishment. Requires the Web/API backend to be reachable only through the local Serve proxy.',
    category: 'server',
    sensitive: false,
    runtimeEditable: false,
  },
  {
    name: 'CAT_CAFE_REMOTE_OWNER_LOGIN',
    defaultValue: '(unset)',
    description: 'Exact Tailscale login allowed to establish the remote owner session.',
    category: 'server',
    sensitive: true,
    runtimeEditable: false,
  },
