  ...
  return new Promise((resolve, reject) => {
    const socket = ioClient(`http://127.0.0.1:${port}`, {
      ...
      extraHeaders: {
        ...
        cookie: `cat_cafe_session=${TEST_SESSION_TOKEN}`,
      },
      auth,
    });
...
describe('SocketManager cancel_invocation', () => {
  ...
  beforeEach(async () => {
    ...
    socketManager = new SocketManager(httpServer, invocationTracker, undefined, {
    ...
    socketManager.setThreadAccessResolver(async (threadId, dataUserId) => {
      return threadId === 'thread-1' && dataUserId === 'default-user';
    });
